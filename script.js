...
const i18n = {
  es: {
    ...
    hero_title:"Más pacientes para tu clínica — locales y del exterior.",
    hero_sub:"La primera agencia de marketing enfocada exclusivamente en clínicas estéticas y turismo médico en Bogotá. Precios transparentes y reporte de retorno por procedimiento — no por \"me gusta\".",
    ...
    dif2_t:"Turismo médico bilingüe", dif2_p:"Atraemos pacientes internacionales con campañas en español e inglés — un canal de alto ticket que casi nadie trabaja.",
    ...
    test2_q:'"Trabajamos con otra agencia antes y solo nos traían \'me gusta\'. Con KASHILAV el reporte me muestra exactamente cuánto generó cada anuncio por procedimiento."',
    ...
    plan_sub:"Sin permanencia oculta. El presupuesto de anuncios es aparte y siempre en tu cuenta — tú ves cada peso.",
    p_tag:"Más elegido", p_cta:"Quiero este plan",
    p1_t:"Esencial", p1_for:"Clínica pequeña o iniciando",
    p1_1:"Meta Ads (pacientes locales)", p1_2:"Gestión de redes (2 posts/semana)", p1_3:"Google Business optimizado", p1_4:"Reporte mensual de resultados",
    p2_t:"Crecimiento", p2_for:"Clínica que quiere crecer en serio",
    p2_1:"Todo lo del plan Esencial", p2_2:"Google Ads + SEO local Bogotá", p2_3:"Contenido bilingüe (ES/EN)", p2_4:"Dashboard de ROI en vivo", p2_5:"Automatización de leads por WhatsApp",
    ...
    s2_time:"Semanas 2–4",
    s2_t:"Estrategia y campañas", s2_p:"Montamos las campañas locales e internacionales en tus propias cuentas de anuncios (Meta + Google). Configuramos la automatización de WhatsApp y el dashboard de ROI. Reunión quincenal de resultados incluida.",
    ...
    faq3_a:"No puedes saberlo con certeza antes de arrancar — nadie que sea honesto te lo prometería. Lo que sí hacemos: en el diagnóstico gratuito estimamos el costo por lead esperado para tu procedimiento en Bogotá, basado en referencias del mercado. Si los números no cierran, te lo decimos antes de que pagues un peso. Y si arrancamos y en 60 días no alcanzamos 2x el valor del plan en leads calificados, el segundo mes no se cobra.",
  ...
  en: {
    ...
    hero_title:"More patients for your clinic — local and from abroad.",
    hero_sub:"The first marketing agency focused exclusively on aesthetic clinics and medical tourism in Bogotá. Transparent pricing and ROI reporting per procedure — not per \"like\".",
    ...
    dif2_t:"Bilingual medical tourism", dif2_p:"We attract international patients with campaigns in Spanish and English — a high-ticket channel almost nobody works.",
    ...
    test2_q:'"We worked with another agency before and they only brought us likes. With KASHILAV the report shows me exactly how much each ad generated per procedure."',
    ...
    plan_sub:"No hidden lock-in. The ad budget is separate and always in your account — you see every dollar.",
    p_tag:"Most chosen", p_cta:"I want this plan",
    p1_t:"Essential", p1_for:"Small or starting clinic",
    p1_1:"Meta Ads (local patients)", p1_2:"Social media (2 posts/week)", p1_3:"Optimized Google Business", p1_4:"Monthly results report",
    p2_t:"Growth", p2_for:"Clinic ready to grow seriously",
    p2_1:"Everything in Essential", p2_2:"Google Ads + local SEO Bogotá", p2_3:"Bilingual content (ES/EN)", p2_4:"Live ROI dashboard", p2_5:"WhatsApp lead automation",
    ...
    s2_time:"Weeks 2–4",
    s2_t:"Strategy & campaigns", s2_p:"We build local and international campaigns in your own ad accounts (Meta + Google). We set up WhatsApp automation and your ROI dashboard. Bi-weekly results meeting included.",
